...
```{r}
census_api_key("4c7e5b613afdf7d2fd6d80005f53282c9a7c1bae",install = TRUE)
...
df_cencus=get_acs(geography = "tract",
                  variables=c("median_inc"="B06011_001",
                              ...
                              "pop_hispanic_latino"="B03001_001"),
                  state="DC",geometry=TRUE,year=2018) 
```
```{r}
df_6 = get_acs(geography = "tract",
               variables = c("mode_of_transportation"="B08101_001",
                             "salary"="B19052_001"),
               state="DC",geometry = TRUE,year=2018)
...
df_6 %>% select(-moe) %>% spread(variable,estimate) 

tm_shape(df_6)+tm_polygons("salary",alpha=.5)
```
